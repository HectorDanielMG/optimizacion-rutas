...
def busqueda_costo_uniforme_route():
    ...
    # Convertir las coordenadas de la ruta a un formato JSON serializable
    coordenadas_ruta = [coord[ciudad] for ciudad in resultado]
    
    return render_template('result.html', algoritmo='Resultado de la Optimizacion', ruta=resultado, distancia_total=distancia_total, coordenadas_ruta=coordenadas_ruta, start_city=start_city, end_city=end_city)
